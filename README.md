...
3. Идеи возможного улучшения качества модели приведены ниже
...
#### 1 Часть:
 ...
 Пробовала разные расписания и стартовые значения, в итоге, остановилась на 
  ...
  ```
  После исправлений lr выглядит так:
 ...
 Результат хороший, видим, что прибавили в точности (синий график - бейзлайн)
#
#### 2 Часть:
Далее, я пробовала менять архитектуру сети:
  ...
  Данные подходы не принесли увеличение качества на validate (приведены графики на трейне: рыжий (выше всех) - со всеми улучшениями из 1ой части, остальные цвета - опробованные действия по улучшению архитектуры - 2ая часть)
 #
 #### 3 Часть: 
  ...
  <img src=https://github.com/krDaria/freesound_audio_tagging_2019/raw/master/images/loss_lrap_4.png height="300">
  
  Результат хороший, видим, что прибавили точность (приведены графики на валидационной части выборки, рыжий - с добавлением аугментации, серый - с измененным лоссом, красный - бейзлайн, розовый - со всеми улучшениями выше)
  
  
  - _Не успела попробовать - изменение `sampler` в `DataLoader`_
#
Проверка точности: *to be continued* (когда откроют соревнование)
